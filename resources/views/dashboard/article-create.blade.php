        ...
        <div class="flex-1 overflow-auto">
            ...
            <main class="px-4 py-6 sm:px-6 lg:px-8">
                <div class="bg-white p-6 rounded-lg shadow-md mb-8 max-w-3xl mx-auto">
                    <h2 class="text-xl font-bold mb-4 text-gray-800">Create New Article</h2>
                    <form action="{{ route('article.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <label for="article_Name" class="block text-sm font-medium text-gray-700">Name <span
                                    class="text-red-500">*</span></label>
                            <input type="text" value="{{ old('article_Name') }}" id="article_Name" name="article_Name"
                                required
                        ...
                        <!-- Parent Category -->
                        <div>
                            <label for="category_id" class="block text-sm font-medium text-gray-700">Parent Category
                        ...
                        <!-- article_Content -->
                        <div>
                            <label for="article_Content" class="block text-sm font-medium text-gray-700">Body <span
                                    class="text-red-500">*</span></label>
                            <textarea id="article_Content" value="{{ old('article_Content') }}" name="article_Content" required rows="4"
