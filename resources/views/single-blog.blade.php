            ...
            <article class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6 md:p-8">
                    <div class="flex items-center text-sm text-gray-500 mb-4">
                        <span class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs">{{ $article->category->name }}</span>
                        <span class="mx-2">•</span>
                        <span>
                            @php
                                ds($article->created_at);
                            @endphp

                            {{ \Carbon\Carbon::parse($article->created_at)->format('M d, Y - H:i') }}
                    ...
                    <h1 class="text-3xl md:text-4xl font-bold mb-6 text-gray-800">{{ $article->article_Name }}</h1>
